<form method="POST" action="{{ route('employee.store') }} ">
    ...
    <div class="mt-4">
        ...
        <x-text-input id="department_id" class="block mt-1 w-full" type="text" name="department_id" required
    ...
    <!-- Position ID -->
    <div class="mt-4">
        <x-input-label for="position_id" :value="__('Position ID')" />

        <x-text-input id="position_id" class="block mt-1 w-full" type="text" name="position_id" required
    ...
    <div class="mt-4">
        <x-input-label for="position_id" :value="__('Duration')" />
        <div datepicker-format="yyyy-mm-dd" id="date-range-picker" date-rangepicker class="flex items-center">
            <div class="relative">
